...
public class MyAccountServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// Get value from EmployeeHasType table. Can either use to call EmployeeType
		// table to get String or just use typeID for if statements.
		// int typeID = ehti.getType(emplID);
		// emplType = eti.getType(typeID);

		// Does check for employee/supervisor. May be removed/reimplemented for checks
		// for admin specific functions.
		if (session != null) {
