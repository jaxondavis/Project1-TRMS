...
public class MyAccountApplicationCreateServlet extends HttpServlet {
	 ...
	 *      response) Get current session & params if session isn't void.
	 */
	...
	/**
	 * @see HttpServlet#doPut(HttpServletRequest, HttpServletResponse) Send
	 *      submitted info to ApplicationDaoImpl to create/update row in DB. (Would
	 *      this be done by setAttribute or getAttribute for session?
	 */
